...
var (
	...
	TokenMissing  = add(20001) //token不存在
	TokenTimedOut = add(20002) //token超时
	TokenInvalid  = add(20003) //token非法
	LoginTimedOut = add(20004) //登录超时
	//授权
	Access_Denied = add(30001) //token无权限
